...
class TableViewControllerActividades: UITableViewController, protocolModificarActividad {
    ...
    func modificarAct(cali: Int, coment: String) {
        let index = tableView.indexPathForSelectedRow!
        listaAct[index.row].calif = cali
        listaAct[index.row].coment = coment
    ...
    */
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        ...
        if segue.identifier == "muestra"{
            let vistaMuestra = segue.destination as! ViewController
            let indexPath = tableView.indexPathForSelectedRow!
            vistaMuestra.act = listaAct[indexPath.row]
            vistaMuestra.temp = self
         }
